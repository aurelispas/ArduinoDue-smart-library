...
{
 Relay_arr[num].state=state; //here you can put your own relay setState realisation 
}
...
{
Serial.print(Relay_arr[num].state); //here you can put your own relay getState realisation 
}
